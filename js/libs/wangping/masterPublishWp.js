		...
		return(
			<div className="formWarp">
				...
				<div className="btnWarp">
					<button className="btn left" onClick={this.uploadFile.bind(this)}>上传</button>
				</div>
				{/* } */}
				...
				<div className="btnWarp">
					<button className="btn left" onClick={this._submit.bind(this)}>保存</button>
