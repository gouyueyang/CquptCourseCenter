...
class FromWarp extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            zcWarn: '',
            zy: this.outMaster.research || '',        //学科领域
            zyWarn: '',
            ...
            <div className="formWarp">
                <div className="inputGroup">
                    <div className="inputWarp">
                        ...
                        <input type="text" className="text" value={this.state.account} onInput={this._input.bind(this, 'account', '账号')} disabled ={this.isEditor?true:false}/>
                    ...
                    <div className="inputWarp" >
                        ...
                        <input type="text" className="text" value={this.state.zy} onInput={this._input.bind(this, 'zy', '学科领域')} />
                ...
                <p className="tips">注意：校外专家初始密码为：cqupt@123</p>
                <div className='btnWarp'>
                    <button className="btn choose" ref={ref => this.addBtn = ref} onClick={this._save}>保存</button>
    ...
    render() {
        return (
            <div className="inside">
                ...
                <div className="btnWarp">
                    <button className={this.state.flag ? "btn choose" : "btn stop"} onClick={this.add}>添加</button>
                    <button className="btn" onClick={() => { location = './zjkgl.html' }}>返回</button>
                </div>
            </div>
