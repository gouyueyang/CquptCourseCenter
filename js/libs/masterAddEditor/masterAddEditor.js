        ...
        return (
            <div className="formWarp">
                ...
                <div className='btnWarp'>
                    <button className="btn choose" ref={ref => this.addBtn = ref} onClick={this._save}>添加</button>
    ...
    render() {
        return (
            <div className="inside">
                ...
                <div className="btnWarp">
                    <button className={this.state.flag ? "btn" : "btn stop"} onClick={this.add}>添加</button>
                    <button className="btn" onClick={() => { location = './zjkgl.html' }}>返回</button>
                </div>
            </div>
