...
var BluMUI = require('../../libs/courseManage/classManageCheck.js'),
...
function getModuleURL(type, courseNo) {
	switch (type) {
		case '课程简介':
			return '../classInfShow/courseJianjie.html?classId=' + courseNo + '&place=3';
		case '教学团队':
			return '../classInfShow/teamShow.html?classId=' + courseNo;
		case '电子教案':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&moduleName=' + encodeURIComponent('电子教案') + '&place=3';
		case '考试大纲':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&moduleName=' + encodeURIComponent('考试大纲') + '&place=3';
		case '考核方案':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&moduleName=' + encodeURIComponent('考核方案') + '&place=3';
		case '教学大纲':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&moduleName=' + encodeURIComponent('教学大纲') + '&place=3';
		case '导学方案':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&moduleName=' + encodeURIComponent('导学方案') + '&place=3';
		case '授课计划':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&place=3';
		case '实习计划':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&place=3';
		case '知识点体系':
			return '../classInfShow/classMasterModule.html?classId=' + courseNo + '&moduleName=' + encodeURIComponent('知识体系') + '&place=3';
		case '学习资源':
			return '../classInfShow/courseShow.html?classId=' + courseNo + '&moduleName=' + encodeURIComponent('视频') + '&place=3';
	}
}
